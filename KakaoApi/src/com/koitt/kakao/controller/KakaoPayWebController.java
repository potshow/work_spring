...
public class KakaoPayWebController {
	...
	@RequestMapping(value="/ready.do", method=RequestMethod.GET)
	public String ready(@RequestParam Map<String, String> order, HttpSession session) throws JsonParseException, JsonMappingException, IOException {
		...
		params.add("total_amount", order.get("itial_amount"));
		...
		params.add("cancel_url", "http://localhost:8080/KakaoApi/kakao-pay/concel.do");
		params.add("fail_url", "http://localhost:8080/KakaoApi/kakao-pay/fail.do");
		
		// 서버로 요청할 Header
		HttpHeaders headers = new HttpHeaders();
		headers.add("Authorization", "KakaoAK " + "139920c9fb7c463a1b2429bd30f167da");
		...
		return "redirect:/kakao-pay/ready.do";	// 임시로 이동
	}
}