...
INSERT INTO users (email, password, name, attachment) 
	VALUES	('admin@naver.com', 
		'$2a$10$MzzmhmOpVRb1VgME/ei37.iXjvxFr8FtzFVlZkIiyndqbtyykQfWy', '강예은관리자', NULL);
	
INSERT INTO users (email, password, name, attachment) 
	VALUES	('user1@naver.com', 
		'$2a$10$MzzmhmOpVRb1VgME/ei37.iXjvxFr8FtzFVlZkIiyndqbtyykQfWy', '주지훈', NULL);
	
INSERT INTO users (email, password, name, attachment) 
	VALUES	('user2@naver.com', 
		'$2a$10$MzzmhmOpVRb1VgME/ei37.iXjvxFr8FtzFVlZkIiyndqbtyykQfWy', '원빈', NULL);

# 사용자에게 권한 부여
INSERT INTO users_authority VALUES (1, 10); # 관리자 사용자에게 관리자 권한 부여
INSERT INTO users_authority VALUES (2, 20); # 주지훈 사용자에게 사용자 권한 부여
INSERT INTO users_authority VALUES (2, 10); # 주지훈 사용자에게 관리자 권한 부여
INSERT INTO users_authority VALUES (3, 20); # 원빈 사용자에게 사용자 권한 부여
...
# 6. 사용자 번호 3번 유저와 같이 관리자 권한과 일반사용자 권한을 함께 입력할 경우 (오라클 사용할 때)
	INSERT ALL
