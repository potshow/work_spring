...
@ContextConfiguration(locations="/com/koitt/config/appliactionContext.xml")
public class UserDaoTest {
	/*
	 * 테스트 객체가 만들어지고 나면 스프링 테스트 컨텍스트에 의해 자동으로 값이 주입 됨
	 * 이렇게 사용하는 이유-> 컨텍스트 객체가 여러개 생성되는 것을 방지하기 위해서
	 */
	@Autowired
	...
	public void setUp() {
		...
		this.user2 = new User("speed", "이승훈", "1234");
		this.user3 = new User("skeleton", "윤성빈", "1234");
		
		// 생성된 컨텍스트 객체와 UserDaoTest 객체의 주소값을 출력
